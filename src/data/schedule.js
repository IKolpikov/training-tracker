...
export const schedule = {
  ...
  "Чт": { label: "Thursday",  circuitType: "A",   circuitLabel: "Full circuit",
          strength: ["rdl_classic","iso_hamstring","gliders","calf_raises","gluteus_medius","copenhagen","bulgarian","bench"],
          cardio: ["basketball"] },
  "Пт": { label: "Friday",    circuitType: "C",   circuitLabel: "Circuit C (pre-intervals)",
          strength: ["rdl_single_leg","iso_hamstring","gliders","calf_raises","gluteus_medius","copenhagen","bulgarian"],
          cardio: ["z2_cycle"] },
